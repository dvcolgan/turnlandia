...
var Action, ActionManager, BuildCityAction, BuildRoadAction, ClearForestAction, InitialPlacementAction, MoveAction, RecruitUnitAction,
...
ClearForestAction = (function(_super) {
  ...
  ClearForestAction.prototype.isValid = function() {
    ...
    if (TB.board.clearForestOverlay.get(this.col, this.row) === null) {
      return false;
    }
    return true;
  };
...
ActionManager = (function() {
  ...
  ActionManager.prototype.cancelMove = function() {
    ...
    if (action.kind === 'move' && !action.finished) {
      ...
      this.actions.pop();
      return $('.btn-move').removeClass('btn-yellow').find('span').html('Move<br/>Unit');
    } else {
