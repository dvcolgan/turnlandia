...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Unit.last_turn_amount'
        db.add_column(u'game_unit', 'last_turn_amount',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Unit.last_turn_amount'
        db.delete_column(u'game_unit', 'last_turn_amount')
    ...
    models = {
        ...
        u'game.square': {
            ...
            'color': ('django.db.models.fields.CharField', [], {'default': "'white'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
