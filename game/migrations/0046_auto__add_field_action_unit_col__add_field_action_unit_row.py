...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.unit_col'
        db.add_column(u'game_action', 'unit_col',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Action.unit_row'
        db.add_column(u'game_action', 'unit_row',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.unit_col'
        db.delete_column(u'game_action', 'unit_col')

        # Deleting field 'Action.unit_row'
        db.delete_column(u'game_action', 'unit_row')
    ...
    models = {
        ...
        u'game.action': {
            ...
            'unit': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'actions'", 'null': 'True', 'to': u"orm['game.Unit']"}),
            'unit_col': ('django.db.models.fields.IntegerField', [], {}),
            'unit_row': ('django.db.models.fields.IntegerField', [], {})
        },
        u'game.message': {
        ...
        u'game.square': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'row': ('django.db.models.fields.IntegerField', [], {}),
            'terrain_type': ('django.db.models.fields.IntegerField', [], {})
        },
        u'game.trophy': {
