...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Account.unplaced_units'
        db.delete_column(u'game_account', 'unplaced_units')


    def backwards(self, orm):
        # Adding field 'Account.unplaced_units'
        db.add_column(u'game_account', 'unplaced_units',
