...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Action.destCol'
        db.delete_column(u'game_action', 'destCol')

        # Deleting field 'Action.destRow'
        db.delete_column(u'game_action', 'destRow')

        # Adding field 'Action.move_path'
        db.add_column(u'game_action', 'move_path',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Action.destCol'
        db.add_column(u'game_action', 'destCol',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Action.destRow'
        db.add_column(u'game_action', 'destRow',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Action.move_path'
        db.delete_column(u'game_action', 'move_path')
