...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Square.terrain_type'
        db.delete_column(u'game_square', 'terrain_type')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Square.terrain_type'
        raise RuntimeError("Cannot reverse this migration. 'Square.terrain_type' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Square.terrain_type'
        db.add_column(u'game_square', 'terrain_type',
