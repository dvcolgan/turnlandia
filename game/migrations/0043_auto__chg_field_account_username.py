...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'game_account', 'username', self.gf('django.db.models.fields.CharField')(unique=True, max_length=25))

    def backwards(self, orm):

        # Changing field 'Account.username'
        db.alter_column(u'game_account', 'username', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))
