...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.country_name'
        db.add_column(u'game_account', 'country_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.country_name'
        db.delete_column(u'game_account', 'country_name')
