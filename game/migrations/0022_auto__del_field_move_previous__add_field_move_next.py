...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Move.previous'
        db.delete_column(u'game_move', 'previous_id')

        # Adding field 'Move.next'
        db.add_column(u'game_move', 'next',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='previous', null=True, to=orm['game.Move']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Move.previous'
        db.add_column(u'game_move', 'previous',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['game.Move'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Move.next'
        db.delete_column(u'game_move', 'next_id')
