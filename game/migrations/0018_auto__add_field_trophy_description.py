...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trophy.description'
        db.add_column(u'game_trophy', 'description',
                      self.gf('django.db.models.fields.CharField')(default='trophy', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trophy.description'
        db.delete_column(u'game_trophy', 'description')
    ...
    models = {
        ...
        u'game.account': {
            ...
            'trophies': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'owners'", 'symmetrical': 'False', 'to': u"orm['game.Trophy']"}),
