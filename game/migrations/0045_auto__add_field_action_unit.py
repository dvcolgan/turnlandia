...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Action.unit'
        db.add_column(u'game_action', 'unit',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='actions', null=True, to=orm['game.Unit']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Action.unit'
        db.delete_column(u'game_action', 'unit_id')
