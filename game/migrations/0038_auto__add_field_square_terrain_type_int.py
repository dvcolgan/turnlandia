...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Square.terrain_type_int'
        db.add_column(u'game_square', 'terrain_type_int',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Square.terrain_type_int'
        db.delete_column(u'game_square', 'terrain_type_int')
