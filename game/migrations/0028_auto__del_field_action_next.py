...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Action.next'
        db.delete_column(u'game_action', 'next_id')


    def backwards(self, orm):
        # Adding field 'Action.next'
        db.add_column(u'game_action', 'next',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='previous', null=True, to=orm['game.Action'], blank=True),
                      keep_default=False)
