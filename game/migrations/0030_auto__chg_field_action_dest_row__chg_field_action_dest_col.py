...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Action.dest_row'
        db.alter_column(u'game_action', 'dest_row', self.gf('django.db.models.fields.IntegerField')(default=1))

        # Changing field 'Action.dest_col'
        db.alter_column(u'game_action', 'dest_col', self.gf('django.db.models.fields.IntegerField')(default=1))

    def backwards(self, orm):

        # Changing field 'Action.dest_row'
        db.alter_column(u'game_action', 'dest_row', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Action.dest_col'
        db.alter_column(u'game_action', 'dest_col', self.gf('django.db.models.fields.IntegerField')(null=True))
