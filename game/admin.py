...
class AccountAdmin(UserAdmin):
    ...
    list_display = ('username', 'email', 'color', 'leader_name', 'people_name', 'total_units', 'is_superuser', 'last_login', 'date_joined')
    fieldsets = (
        (None, {'fields': ('username', 'email', 'color', 'leader_name', 'people_name', 'total_units', 'password')}),
